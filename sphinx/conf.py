...
# -*- coding: utf-8 -*-
#
# binary_encoding documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = 'binary_encoding'
copyright = 'Steven de Oliveira <de.oliveira.steven@gmail.com>'
...
latex_documents = [
    (master_doc, 'binary_encoding.tex', 'binary_encoding Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'binary_encoding', 'binary_encoding Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'binary_encoding', 'binary_encoding Documentation',
     author, 'binary_encoding', 'One line description of project.',
     'Miscellaneous'),
]
