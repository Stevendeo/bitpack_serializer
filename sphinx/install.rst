...
If :code:`binary_encoding` is available in your opam repository, you can just call::

  opam install binary_encoding

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`binary_encoding` in a directory.
